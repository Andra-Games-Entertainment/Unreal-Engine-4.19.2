...
public:
	...
	virtual void StartupModule() override
	{
		...
		// Ideally, we should be able to query GetDefault<UMagicLeapSettings>()->bEnableVDZI directly.
		...
		GConfig->GetBool(TEXT("/Script/MagicLeap.MagicLeapSettings"), TEXT("bEnableVDZI"), bIsVDZIEnabled, GEngineIni);
...
const FKey FMagicLeapController::FMagicLeapKeys::Left_TapGesture("MagicLeap_Left_TapGesture");
const FName FMagicLeapControllerKeyNames::Left_TapGesture_Name("MagicLeap_Left_TapGesture");

const FKey FMagicLeapController::FMagicLeapKeys::Left_SwipeUpGesture("MagicLeap_Left_SwipeUpGesture");
const FName FMagicLeapControllerKeyNames::Left_SwipeUpGesture_Name("MagicLeap_Left_SwipeUpGesture");

const FKey FMagicLeapController::FMagicLeapKeys::Left_SwipeDownGesture("MagicLeap_Left_SwipeDownGesture");
const FName FMagicLeapControllerKeyNames::Left_SwipeDownGesture_Name("MagicLeap_Left_SwipeDownGesture");

const FKey FMagicLeapController::FMagicLeapKeys::Left_RadialScrollGesture("MagicLeap_Left_RadialScrollGesture");
const FName FMagicLeapControllerKeyNames::Left_RadialScrollGesture_Name("MagicLeap_Left_RadialScrollGesture");
...
const FKey FMagicLeapController::FMagicLeapKeys::Right_TapGesture("MagicLeap_Right_TapGesture");
const FName FMagicLeapControllerKeyNames::Right_TapGesture_Name("MagicLeap_Right_TapGesture");

const FKey FMagicLeapController::FMagicLeapKeys::Right_SwipeUpGesture("MagicLeap_Right_SwipeUpGesture");
const FName FMagicLeapControllerKeyNames::Right_SwipeUpGesture_Name("MagicLeap_Right_SwipeUpGesture");

const FKey FMagicLeapController::FMagicLeapKeys::Right_SwipeDownGesture("MagicLeap_Right_SwipeDownGesture");
const FName FMagicLeapControllerKeyNames::Right_SwipeDownGesture_Name("MagicLeap_Right_SwipeDownGesture");

const FKey FMagicLeapController::FMagicLeapKeys::Right_RadialScrollGesture("MagicLeap_Right_RadialScrollGesture");
const FName FMagicLeapControllerKeyNames::Right_RadialScrollGesture_Name("MagicLeap_Right_RadialScrollGesture");
...
inline bool TouchpadGestureToKeyName(EControllerHand Hand, const MLInputControllerTouchpadGesture* TouchpadGesture, FName& outKeyName)
{
	switch (TouchpadGesture->type)
	{
		case MLInputControllerTouchpadGestureType_Tap:
			outKeyName = (Hand == EControllerHand::Left) ?
				FMagicLeapControllerKeyNames::Left_TapGesture_Name : FMagicLeapControllerKeyNames::Right_TapGesture_Name;
			break;
		case MLInputControllerTouchpadGestureType_Swipe:
			if (TouchpadGesture->direction == MLInputControllerTouchpadGestureDirection_Up)
			{
				outKeyName = (Hand == EControllerHand::Left) ?
					FMagicLeapControllerKeyNames::Left_SwipeUpGesture_Name : FMagicLeapControllerKeyNames::Right_SwipeUpGesture_Name;
			}
			else if (TouchpadGesture->direction == MLInputControllerTouchpadGestureDirection_Down)
			{
				outKeyName = (Hand == EControllerHand::Left) ?
					FMagicLeapControllerKeyNames::Left_SwipeDownGesture_Name : FMagicLeapControllerKeyNames::Right_SwipeDownGesture_Name;
			}
			else
			{
				return false;
			...
			break;
		case MLInputControllerTouchpadGestureType_RadialScroll:
			outKeyName = (Hand == EControllerHand::Left) ?
				FMagicLeapControllerKeyNames::Left_RadialScrollGesture_Name : FMagicLeapControllerKeyNames::Right_RadialScrollGesture_Name;
			break;
		default:
			return false;
	}
...
void FMagicLeapController::OnTouchpadGestureStart(EControllerHand Hand, const MLInputControllerTouchpadGesture* TouchpadGesture)
{
	// NOTE: This is temporary; Epic has a Jira task to pipe touchpad gestures through correctly post-R7 but we need
	// something for the interim - rmobbs
	FName KeyName;
	if (TouchpadGestureToKeyName(Hand, TouchpadGesture, KeyName))
	{
		FMagicLeapHMD::EnableInput EnableInputFromHMD;
		// fixes unreferenced parameter error for Windows package builds.
		(void)EnableInputFromHMD;
		MessageHandler->OnControllerButtonPressed(KeyName, DeviceIndex, false);
	}
}

void FMagicLeapController::OnTouchpadGestureContinue(EControllerHand Hand, const MLInputControllerTouchpadGesture* TouchpadGesture)
{
	// NOTE: This is temporary; Epic has a Jira task to pipe touchpad gestures through correctly post-R7 but we need
	// something for the interim - rmobbs
	FName KeyName;
	if (TouchpadGestureToKeyName(Hand, TouchpadGesture, KeyName))
	{
		...
		// fixes unreferenced parameter error for Windows package builds.
		(void)EnableInputFromHMD;
		MessageHandler->OnControllerButtonPressed(KeyName, DeviceIndex, true);
	}
}

void FMagicLeapController::OnTouchpadGestureEnd(EControllerHand Hand, const MLInputControllerTouchpadGesture* TouchpadGesture)
{
	// NOTE: This is temporary; Epic has a Jira task to pipe touchpad gestures through correctly post-R7 but we need
	// something for the interim - rmobbs
	FName KeyName;
	if (TouchpadGestureToKeyName(Hand, TouchpadGesture, KeyName))
	{
		...
		// fixes unreferenced parameter error for Windows package builds.
		(void)EnableInputFromHMD;
		MessageHandler->OnControllerButtonReleased(KeyName, DeviceIndex, false);
	}
}
...
void FMagicLeapController::SendControllerEvents()
{
	if (bIsInputStateValid && MessageHandler.IsValid())
	{
		...
		{
			FScopeLock Lock(&TouchGestureCriticalSection);
			for (const FTouchpadGestureMap& touchpad : PendingTouchpadGestureStart)
			{
				OnTouchpadGestureStart(touchpad.Hand, &touchpad.TouchpadGesture);
			}
			for (const FTouchpadGestureMap& touchpad : PendingTouchpadGestureContinue)
			{
				OnTouchpadGestureContinue(touchpad.Hand, &touchpad.TouchpadGesture);
			}
			for (const FTouchpadGestureMap& touchpad : PendingTouchpadGestureEnd)
			{
				OnTouchpadGestureEnd(touchpad.Hand, &touchpad.TouchpadGesture);
			}
	...
	if (ControllerIndex != nullptr)
	{
		...
		if ((ControllerState != nullptr) && (ControllerState->bIsConnected) && (FApp::HasVRFocus()))
		{
			...
			else
			{
				if (HapticBuffer)
				{
					//UE_LOG(LogMagicLeapController, Log, TEXT("Haptic Buffer not sampled at the correct frequency : %d vs %d"), SampleRateHz, HapticBuffer->SamplingRate);
				}
...
void FMagicLeapController::AddKeys()
{
	...
	EKeys::AddKey(FKeyDetails(FMagicLeapKeys::Left_TapGesture, LOCTEXT("MagicLeap_Left_TapGesture", "ML (L) Tap Gesture (DEPRECATED)"), FKeyDetails::GamepadKey));
	...
	EKeys::AddKey(FKeyDetails(FMagicLeapKeys::Left_SwipeUpGesture, LOCTEXT("MagicLeap_Left_SwipeUpGesture", "ML (L) Swipe Up (DEPRECATED)"), FKeyDetails::GamepadKey));
	EKeys::AddKey(FKeyDetails(FMagicLeapKeys::Left_SwipeDownGesture, LOCTEXT("MagicLeap_Left_SwipeDownGesture", "ML (L) SWipe Down (DEPRECATED)"), FKeyDetails::GamepadKey));
	EKeys::AddKey(FKeyDetails(FMagicLeapKeys::Left_RadialScrollGesture, LOCTEXT("MagicLeap_Left_RadialScrollGesture", "ML (L) Radial Scroll (DEPRECATED)"), FKeyDetails::GamepadKey));
	...
	EKeys::AddKey(FKeyDetails(FMagicLeapKeys::Right_TapGesture, LOCTEXT("MagicLeap_Right_TapGesture", "ML (R) Tap Gesture (DEPRECATED)"), FKeyDetails::GamepadKey));
	...
	EKeys::AddKey(FKeyDetails(FMagicLeapKeys::Right_SwipeUpGesture, LOCTEXT("MagicLeap_Right_SwipeUpGesture", "ML (R) Swipe Up (DEPRECATED)"), FKeyDetails::GamepadKey));
	EKeys::AddKey(FKeyDetails(FMagicLeapKeys::Right_SwipeDownGesture, LOCTEXT("MagicLeap_Right_SwipeDownGesture", "ML (R) SWipe Down (DEPRECATED)"), FKeyDetails::GamepadKey));
	EKeys::AddKey(FKeyDetails(FMagicLeapKeys::Right_RadialScrollGesture, LOCTEXT("MagicLeap_Right_RadialScrollGesture", "ML (R) Radial Scroll (DEPRECATED)"), FKeyDetails::GamepadKey));
}
...
MLInputControllerFeedbackColorLED FMagicLeapController::UnrealToMLColorLED(EMLControllerLEDColor LEDColor) const
{
	switch (LEDColor)
	{
		case EMLControllerLEDColor::Red0:
			return MLInputControllerFeedbackColorLED_Red0;
		case EMLControllerLEDColor::Red1:
			return MLInputControllerFeedbackColorLED_Red1;
		case EMLControllerLEDColor::Red2:
			return MLInputControllerFeedbackColorLED_Red2;
		case EMLControllerLEDColor::Orange0:
			return MLInputControllerFeedbackColorLED_Orange0;
		case EMLControllerLEDColor::Orange1:
			return MLInputControllerFeedbackColorLED_Orange1;
		case EMLControllerLEDColor::Orange2:
			return MLInputControllerFeedbackColorLED_Orange2;
		case EMLControllerLEDColor::Yellow0:
			return MLInputControllerFeedbackColorLED_Yellow0;
		case EMLControllerLEDColor::Yellow1:
			return MLInputControllerFeedbackColorLED_Yellow1;
		case EMLControllerLEDColor::Yellow2:
			return MLInputControllerFeedbackColorLED_Yellow2;
		case EMLControllerLEDColor::Pink0:
			return MLInputControllerFeedbackColorLED_Pink0;
		case EMLControllerLEDColor::Pink1:
			return MLInputControllerFeedbackColorLED_Pink1;
		case EMLControllerLEDColor::Pink2:
			return MLInputControllerFeedbackColorLED_Pink2;
		case EMLControllerLEDColor::Purple0:
			return MLInputControllerFeedbackColorLED_Purple0;
		case EMLControllerLEDColor::Purple1:
			return MLInputControllerFeedbackColorLED_Purple1;
		case EMLControllerLEDColor::Purple2:
			return MLInputControllerFeedbackColorLED_Purple2;
		default:
...
void FMagicLeapController::InitializeInputCallbacks()
{
	...
	InputControllerCallbacks.on_touchpad_gesture_start = [](uint8 controller_id, const MLInputControllerTouchpadGesture *touchpad_gesture, void *data)
	{
		...
		if (controller)
		{
			...
			{
				FScopeLock Lock(&controller->TouchGestureCriticalSection);
				FTouchpadGestureMap Touchpad;
				Touchpad.Hand = hand;
				Touchpad.TouchpadGesture = *touchpad_gesture;
				controller->PendingTouchpadGestureStart.Add(Touchpad);
	...
	InputControllerCallbacks.on_touchpad_gesture_continue = [](uint8 controller_id, const MLInputControllerTouchpadGesture *touchpad_gesture, void *data)
	{
		...
		if (controller)
		{
			...
			controller->GetControllerMapping(controller_id, hand);
			{
				...
				Touchpad.Hand = hand;
				Touchpad.TouchpadGesture = *touchpad_gesture;
				controller->PendingTouchpadGestureContinue.Add(Touchpad);
	...
	InputControllerCallbacks.on_touchpad_gesture_end = [](uint8 controller_id, const MLInputControllerTouchpadGesture *touchpad_gesture, void *data)
	{
		...
		if (controller)
		{
			...
			controller->GetControllerMapping(controller_id, hand);
			{
				...
				Touchpad.Hand = hand;
				Touchpad.TouchpadGesture = *touchpad_gesture;
				controller->PendingTouchpadGestureEnd.Add(Touchpad);
