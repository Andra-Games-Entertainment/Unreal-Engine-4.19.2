...
bool UMagicLeapGesturesFunctionLibrary::GetHandCenter(EControllerHand Hand, FTransform& HandCenter)
{
	...
	if (gestures.IsValid() && gestures->IsGestureStateValid())
	{
		if (Hand == EControllerHand::Left)
		{
			...
			{
				HandCenter = gestures->CurrentLeftGestureData().HandCenter;
			}
		...
		else if (Hand == EControllerHand::Right)
		{
			...
			{
				HandCenter = gestures->CurrentRightGestureData().HandCenter;
			}
...
bool UMagicLeapGesturesFunctionLibrary::GetHandPointer(EControllerHand Hand, FTransform& Pointer)
{
	TSharedPtr<FMagicLeapGestures> gestures = StaticCastSharedPtr<FMagicLeapGestures>(IMagicLeapGesturesPlugin::Get().GetInputDevice());
	...
	if (gestures.IsValid() && gestures->IsGestureStateValid())
	{
		if (Hand == EControllerHand::Left)
		{
			const FMagicLeapGestures::FGestureData& GestureData = gestures->CurrentLeftGestureData();
...
bool UMagicLeapGesturesFunctionLibrary::GetHandSecondary(EControllerHand Hand, FTransform& Secondary)
{
	TSharedPtr<FMagicLeapGestures> gestures = StaticCastSharedPtr<FMagicLeapGestures>(IMagicLeapGesturesPlugin::Get().GetInputDevice());
