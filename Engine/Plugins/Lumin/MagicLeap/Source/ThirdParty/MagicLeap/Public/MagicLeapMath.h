...
namespace MagicLeap
{
	...
	FORCEINLINE FRotator ToUERotator(const FRotator& InMLRotation)
	{
		return UKismetMathLibrary::Conv_VectorToRotator(UKismetMathLibrary::RotateAngleAxis(UKismetMathLibrary::Conv_RotatorToVector(InMLRotation), 180, UKismetMathLibrary::GetRightVector(InMLRotation)));
	}
}
