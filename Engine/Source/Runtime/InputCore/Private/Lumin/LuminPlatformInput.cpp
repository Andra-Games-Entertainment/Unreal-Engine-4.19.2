...
#define ADDKEYMAP(KeyCode, KeyName)		if (NumMappings<MaxMappings) { KeyCodes[NumMappings]=KeyCode; if(KeyNames) { KeyNames[NumMappings]=KeyName; } ++NumMappings; };
	...
	if (KeyCodes && (MaxMappings > 0))
	{
		...
		ADDKEYMAP(MLKEYCODE_BACK, TEXT("Nova_Back"));
		ADDKEYMAP(MLKEYCODE_VOLUME_UP, TEXT("Nova_Volume_Up"));
		ADDKEYMAP(MLKEYCODE_VOLUME_DOWN, TEXT("Nova_Volume_Down"));
		ADDKEYMAP(MLKEYCODE_MENU, TEXT("Nova_Menu"));
