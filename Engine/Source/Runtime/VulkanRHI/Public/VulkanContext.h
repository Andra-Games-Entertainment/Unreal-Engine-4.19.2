...
public:
	...
	FRenderingMipChainInfo RenderingMipChainInfo;
...
public:
...
#else
	void RHIBeginOcclusionQueryBatch();
	...
	{
		if ((Surface.GetFullAspectMask() & (VK_IMAGE_ASPECT_DEPTH_BIT | VK_IMAGE_ASPECT_STENCIL_BIT)) != 0)
		{
